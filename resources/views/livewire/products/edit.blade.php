                ...
                <div class="card  shadow ">
                    ...
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h1 class="mb-3 text-center">Update</h1>
                            </div>
                                        ...
                                        <div class="row mb-5">
                                            <div class="col-lg-12">
                                                <div class="form-group focused mb-4">
                                                    <input type="text" wire:model.lazy='productData.name' id="productname" name="productname"  class="form-control form-control-alternative mb-4 @error('productData.name') is-invalid @enderror " placeholder="Name" value="{{ $productData['name'] }}" required>
                                                        @error('productData.name')
                                                            <span class="error text-danger" role="alert">
                                                                <strong>{{$message}}</strong><br>
                                                            </span>
                                                        @enderror
                                                    <input type="number" wire:model.lazy='productData.price'  id="productprice"  class="form-control form-control-alternative mb-4 @error('productData.price') is-invalid  @enderror " placeholder="Flat Price" value="{{ $productData['price'] }}" required>
                                                        @error('productData.price')
                                                            <span class="error text-danger" role="alert">
                                                                <strong>{{$message}}</strong>
                                                            </span>
                                                        @enderror
                                                    <input type="number" wire:model.lazy='productData.quantity' wire:click='priceAdded' id="productquantity"  class="form-control form-control-alternative mb-4 @error('productData.quantity') is-invalid  @enderror " placeholder="Quanity" value="{{ $productData['quantity'] }}" required>
                                                    ...
                                                    <div class="form-check">
                                                        ...
                                                        <div class="text-center mt-4">
                                                            @if($images)
                                                                ...
                                                                @endforeach
                                                            @elseif($product->getImages())
                                                                @foreach ($product->getImages() as $image)
                                                                    <img src="{{ $image }}" width="150px" height="150px" class="rounded img-thumbnail img-fluid mr-2" alt="placeholder images">
                                                                @endforeach
                                                            @else
                                                ...
                                                <div class="row d-flex justify-content-center mt-4">
                                                    <div class="col-lg-8">
                                                        <div class="form-group">
                                                                <button type="submit" wire:click.prevent="update" class="btn btn-dark rounded-pill btn-block btn-lg">{{__('Update') }}</button>
                                                        </div>
                                                    </div>
                                                    <div wire:loading>
                                                    ...
                                                    <div class="row mb-5">
                                                        <div class="col-lg-12">
                                                            ...
                                                            <div class="form-group focused">
                                                                <div class=" container-fluid">
                                                                    @if($images)
                                                                        ...
                                                                        @endif
                                                                            @endforeach
                                                                    @else
                                                                    <img src="{{$product->getMainImage() ? $product->getMainImage() : 'https://via.placeholder.com/500'}}" style="height: 500px" class="img-fluid img-fluid shadow-lg" alt="placeholder images">
                                                                    @endif
                                                                </div>
                                                            </div>
                                                                ...
                                                                <p><span class="mr-1"><strong>£{{$productFinalPrice ? $productFinalPrice : $product->getTotalPrice()}}</strong></span></p>
